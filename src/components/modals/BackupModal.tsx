...
export const BackupModal = (props: { bridge: AirshipBridge<BackupModalResult | undefined>; forgetLoginId?: string }) => {
  ...
  const isDelete = forgetLoginId != null
  ...
  return (
    <ButtonsModal
      ...
      buttons={{
        ...
        dismiss: {
          label: isDelete ? lstrings.delete_account_title : lstrings.backup_dismiss_button,
          onPress: isDelete ? handleDeletePress : undefined,
          spinner: false
        }
      }}
      fullScreen
