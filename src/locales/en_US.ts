...
const strings = {
  ...
  title_fio_add_bundled_txs: 'Purchase more bundled transactions',
  ...
  fio_address_details_bundled_txs_out_soon:
    'You have spent almost all the bundled transactions of your FIO address. Would you like to purchase more bundled transaction?',
  fio_address_details_no_bundled_txs: 'Your FIO address has no bundled transactions. Would you like to purchase more bundled transactions?',
  ...
  rewards_card_purchase_disclaimer:
    'Newly purchased cards take a few seconds to become available. Cards purchased with BTC require 1 confirmation and could take 10-30 minutes to become available.',
  ...
  rewards_card_no_cards: 'You have no active cards.',
